                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <!-- Authentication Links -->
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('product.shoppingCart')); ?>"><i class="fas fa-shopping-cart"></i> <?php echo e(__('Cart')); ?><span class="badge"><?php echo e(Session::has('cart') ? Session::get('cart')->totalQty : ''); ?></span></a>
